...
setwd("/Users/xq/Desktop/睾丸文章总/最新内容汇总/figure汇总/figure2/reactome")

# 读取 CSV 文件
data <- read.csv("/Users/xq/Desktop/睾丸文章总/最新内容汇总/figure汇总/figure2/reactome/DRGs all-ST.csv", header = T, stringsAsFactors = FALSE)
