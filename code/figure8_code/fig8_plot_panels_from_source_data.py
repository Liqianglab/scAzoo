...
SRC = BASE / "figure8_source_data"
OUT = BASE / "figure8_code" / "figure8_plots"
...
def plot_supfig9_main() -> None:
    ...
    fig.text(0.03, 0.992, "Figure 8", ha="left", va="top", fontsize=44)
    ...
    save(fig, "Figure8_main_from_source_data")
